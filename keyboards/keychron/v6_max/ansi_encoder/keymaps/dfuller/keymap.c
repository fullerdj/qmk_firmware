...
/*
 * RGB_VAD/VAI: flashy backlight stuff
 * KC_MCTRL: expose (show all windows) -> KC_MISSION_CONTROL
 * KC_LNPAD: launchpad -> KC_LAUNCHPAD
 * KC_SNAP: screenshot
 * KC_SIRI: display spotlight
 */

enum custom_keycodes {
  DF_REFR = SAFE_RANGE, // browser refresh (command + R)
  DF_HACK,
};

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_109(
//                                                                                                                                         Click wheel is this column. For left/right, see encoder_map below.
//                                                                                                                                            v
        KC_ESC,   KC_BRID,  KC_BRIU,  KC_MCTRL, KC_LNPAD, DF_REFR,  DF_HACK,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU,    KC_MUTE,    KC_SNAP,  KC_SIRI,  RGB_MOD,  KC_F13,   KC_F14,   KC_F15,   KC_F16,
